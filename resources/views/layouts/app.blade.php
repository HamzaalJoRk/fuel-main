...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
        ...
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder"></span><span class="user-status"></span></div><span class="avatar"><img class="round" src="{{asset('logo.jpg')}}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                        <a class="dropdown-item" href="{{ 'profile.edit' }}"><i class="me-50" data-feather="user"></i> العلومات الشخصية</a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand" href="../../../html/rtl/vertical-menu-template/index.html">
    ...
    <footer class="footer footer-static footer-light" style="background-color: white;">
        <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">Copyright © 2025 الهيئة العامة للمنافذ البرية والبحرية . جميع الحقوق محفوظة.<a class="ms-25" href="{{asset('logo.jpg')}}" target="_blank">    </a></span><span class="float-md-end d-none d-md-block">الهيئة العامة للمنافذ البرية والبحرية - المكتب البرمجي <img class="round" src="{{asset('logo.jpg')}}" alt="avatar" height="20" width="20"></span></p>
    </footer>
